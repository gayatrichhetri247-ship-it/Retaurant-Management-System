...
const Login = () => {
  ...
  return (
    <div className="w-full min-h-screen md:h-screen flex flex-col md:flex-row overflow-y-auto md:overflow-hidden bg-gradient-to-br from-white via-blue-50 to-blue-100 relative">
      ...
      <div
        className="absolute bottom-12 right-12 w-80 h-80 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-bg-blob hidden md:block"
